...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/api/manhwaLab/top/**", "/api/manhwaLab/manhwaList", "/api/manhwaLab/*/update-view", "/api/manhwaLab/genres", "/api/manhwaLab/themes", "/api/manhwaLab/types", "/api/manhwaLab/registration", "/login", "/registration", "/images/*", "/api/manhwaLab/*/recommendations", "/api/manhwaLab/comments/*").permitAll()
                .antMatchers("/api/manhwaLab/profile").hasRole(ApplicationUserRoles.USER.name())
                .antMatchers("/api/manhwaLab/addToUser", "/api/manhwaLab/addToReading", "/api/manhwaLab/addToReadLater", "/api/manhwaLab/addToFinished", "/api/manhwaLab/addToFavourites", "/api/manhwaLab/add-comment/*", "/api/manhwaLab/delete-comment/*", "/api/manhwaLab/edit-comment/*").hasRole(ApplicationUserRoles.USER.name())
